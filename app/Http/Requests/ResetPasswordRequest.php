...
class ResetPasswordRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'password.min'=>'Նոր գաղտնաբառը պետք է պարունակի առնվազն 8 նիշ',
            'password.regex'=>"Նոր գաղտնաբառը պետք է պարունակի առնվազն մեկ մեծատառ, մեկ փոքրատառ և մեկ թիվ",
            'password.confirmed' => 'Գաղտնաբառերը չեն համընկնում:',
        ];
    }
}
